...
<table>
	{
	for $photo in /photodb/photo 
	for $viewer in /photodb/belongsTo where $viewer/circleID=$photo/visibility
	return 
	<row>
		<photoID>
			{
	...
	<MapperMetaTag>
		...
		<MapperBlockPosition>
			<template name="xquery_body">
				<block path="table/flwr" x="147" y="53"/>
				<block path="table/flwr/=[1]" x="125" y="58"/>
			</template>
		</MapperBlockPosition>
