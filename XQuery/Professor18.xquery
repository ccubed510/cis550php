...
<table>
	{
	for $professor in /tns:photodb/tns:professor 
	for $student in $professor/tns:advises
	return 
	<row>
		<userName>
			{
			$professor/tns:account_id/text()
			}
		</userName>
		<advisee>
			{
			$professor/../tns:student[tns:id=$student/tns:advisee]/tns:account_id/text()
			}
		</advisee>
	</row>
	}
	...
	<MapperMetaTag>
		...
		<MapperBlockPosition>
			<template name="xquery_body">
				<block path="table/flwr" x="98" y="49"/>
			</template>
		</MapperBlockPosition>
